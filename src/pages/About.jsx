const About = () => {
  return (
    <div className="bg-txt1 dark:bg-bg2 dark:text-txt1 h-screen w-full flex flex-col ">
      <div className="w-full h-[200px] flex justify-center items-center">
        <h1 className="text-bg1 dark:text-txt1 text-2xl">NOSOTROS</h1>
      </div>
      <div className="flex flex-col p-10 ">
        <div className="bg-txt2 dark:bg-bg1 p-4 rounded-md h-[200px] flex flex-col justify-center">
