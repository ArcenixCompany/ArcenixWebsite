    ...
    <>
      <div className="w-full min-h-screen flex flex-col justify-center items-center bg-txt2 dark:bg-bg2">
        <section className="w-fit p-2 bg-d2">
          {/* card */}
          <div className="w-72 h-fit group flex flex-col justify-center items-center bg-bg1 rounded-xl">
            ...
            <h2 className="mt-3 text-xl text-d1">Maimus</h2>
            <p className="text-lg text-d1">Maximiliano Solis</p>
            <p className="text-xl mt-2 text-d1 font-bold p-2">Owner</p>
          </div>
        </section>
      </div>
    </>
